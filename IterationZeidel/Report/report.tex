...
\newpage
\part*{Реализация}
\lstinputlisting[language=C++, style=eclipse, basicstyle=\scriptsize, title={iterationzeidel.h}]{"../IterationZeidel/iterationzeidel.h"}
 
\lstinputlisting[language=C++, style=eclipse, basicstyle=\scriptsize, title={iterationzeidel.cpp}]{"../IterationZeidel/iterationzeidel.cpp"}
 
\lstinputlisting[language=C++, style=eclipse, basicstyle=\scriptsize, title={main.cpp}]{"../IterationZeidel/main.cpp"}
\newpage
